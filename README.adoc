...
[discrete]
= Klimakarte (A250)
Sie befinden sich auf der Startseite des Themas **"Klimakarte (A250)"**. Über folgende Links gelangen Sie zu weiteren Informationen:

* https://ch-sz-geo.github.io/A250/[Daten, Datenmodell, Modellbeschreibung, Erfassungsrichtlinie usw.] zu diesem Thema
