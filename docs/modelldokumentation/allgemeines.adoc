...
* die Klimabewertungskarte und
* die Planungshinweiskarte.

Die Klimaanalysekarte sind im Rasterformat. Die Daten zur Klimabewertungs- und Planungshinweiskarte liegen im Verktorformat vor und sind in INTERLIS modelliert. Dieses Datenmodell ist in der vorliegenden Dokumentation beschrieben.
