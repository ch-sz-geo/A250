...
Das Thema umfasst drei Bereiche:

* die Klimaanalyse,
* die Bewertungskarten Tag und Nacht sowie
* die Planungshinweiskarte.

Die Klimaanalysekarte ist im Rasterformat. Die Daten zur Bewertungs- und Planungshinweiskarte liegen im Vektorformat vor und sind in INTERLIS modelliert. Dieses Datenmodell ist in der vorliegenden Dokumentation beschrieben.
