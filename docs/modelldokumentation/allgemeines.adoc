...
Die Klimaanalysekarte sind im Rasterformat. Die Daten zur Klimabewertungs- und Planungshinweiskarte liegen im Verktorformat vor. Für letztere wurde ein Datenmodell erstellt, welches diesem Thema beiliegt.
